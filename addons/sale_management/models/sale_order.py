...
class SaleOrder(models.Model):
        ...
        for order in self:
            ...
            if companies and companies != order.company_id:
                ...
                raise ValidationError(_(
                    "Your quotation contains products from company %(product_company)s whereas your quotation belongs "
                    "to company %(quote_company)s. \n Please change the company of your quotation or remove the "
                    "products from other companies (%(bad_products)s).",
    ...
    def _onchange_company_id(self):
        """Trigger quotation template re-computation on unsaved records company change"""
        if self._origin.id:
            return
    ...
    def _onchange_sale_order_template_id(self):
        ...
        # set first line to sequence -99, so a re-sequence on first page doesn't cause following page
    ...
    def _recompute_prices(self):
        ...
        # if price list discount_policy is different from when the price was first computed.
