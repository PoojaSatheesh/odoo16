        ...
        for template in self:
            ...
            if len(companies) > 1:
                ...
                raise ValidationError(_(
                    "Your template contains products from company %(product_company)s whereas your template belongs "
                    "to company %(template_company)s. \n Please change the company of your template or remove the "
